...
var $author$project$Main$buttonChangeColors = function (model) {
	return A2(
		...
		{
			label: $mdgriffith$elm_ui$Element$text('Change Color'),
...
var $author$project$Main$catImage = A2(
	...
	{description: 'A picture of a cat', src: 'cat.png'});
...
var $author$project$Main$viewSubtitle = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$text('A web page for my cat')
			]));
};
...
var $author$project$Main$viewTitle = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$text('My Cat')
			]));
};
